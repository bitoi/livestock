...
class TradingFacilityView(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Cơ sở mua bán giống")
    ...
    def _init_ui(self):
        ...
        self.txt_search.setPlaceholderText("Tìm theo tên tổ chức / cá nhân...")
        ...
        self.table.setHorizontalHeaderLabels([
            "ID", "Tên tổ chức/cá nhân", "Huyện", "Xã",
