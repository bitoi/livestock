...
class MaleBreedingOwnerDialog(QDialog):
    ...
    def _init_ui(self):
        ...
        for s in species_service.get_all():
        ...
        form.addRow("Loài đực giống:", self.lst_species)
