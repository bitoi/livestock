...
class FeedTestingFacilityDialog(QDialog):
    def __init__(self, data=None):
        super().__init__()
        self.data = data
        self.setWindowTitle("Thông tin cơ sở khảo nghiệm thức ăn")
        self._init_ui()
    ...
    def _init_ui(self):
        ...
        self.lst_food = QListWidget()
        self.lst_food.setSelectionMode(QListWidget.SelectionMode.MultiSelection)
        ...
        form.addRow("Thức ăn khảo nghiệm:", self.lst_food)
